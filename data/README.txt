...
Note that constrained by the terms of Twitter service, we cannot contain the content of tweets and the user details in these two datasets. Data users can obtain the sepcifics based on the provided tweet IDs and uids by their own.
